...
const DonutChart = core.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(core.Box, { ref, size, ...getStyles("root"), ...others }, /* @__PURE__ */ React.createElement(recharts.ResponsiveContainer, null, /* @__PURE__ */ React.createElement(recharts.PieChart, { ...pieChartProps }, /* @__PURE__ */ React.createElement(
    recharts.Pie,
    {
      data,
